...
export default function Stm32TrainingPage() {
  return <>
    ...
    <main className="case-page">
      <section className="case-hero"><div className="site-wrap case-hero-inner"><div><p className="eyebrow">PROJECT 03 / EMBEDDED SYSTEMS</p><h1>STM32 硬件编程综合实训</h1><p className="case-lead">围绕 STM32F103C8 开发板完成多组外设驱动和硬件联调练习，从 GPIO 基础控制延伸到传感器、显示、通信和灯带效果。</p><div className="case-actions"><a className="button button-primary" href="https://github.com/eaea499" target="_blank" rel="noreferrer">查看 GitHub <ArrowUpRight size={17} /></a><Link className="button button-secondary" href="/projects">返回项目列表</Link></div></div><dl className="case-meta"><div><dt>项目类型</dt><dd>嵌入式课程设计 / 硬件实训</dd></div><div><dt>目标平台</dt><dd>STM32F103C8T6</dd></div><div><dt>开发工具</dt><dd>Keil MDK-ARM / STM32CubeMX</dd></div></dl></div></section>
      ...
      <section className="site-wrap case-end"><Link className="back-link" href="/projects"><ArrowLeft size={16} />返回全部项目</Link><a className="text-link" href="https://github.com/eaea499" target="_blank" rel="noreferrer">访问 GitHub <ArrowUpRight size={17} /></a></section>
    </main>
  </>;
}
